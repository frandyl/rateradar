    ...
    <div className="flex items-center justify-between ml-auto mr-auto">
      ...
      <div>
        {conversionRates && previousRates && (
          <p>
            {renderArrow(
              parseFloat(conversionRates.GHS.toFixed(4)),
              parseFloat(previousRates.GHS.toFixed(4))
            )}
            {parseFloat(conversionRates.GHS.toFixed(4))}
          </p>
        )}
      ...
      <div>
        {conversionRates && previousRates && (
          <p>
            {renderArrow(
              parseFloat((1 / conversionRates.GHS).toFixed(4)),
              parseFloat((1 / previousRates.GHS).toFixed(4))
            )}
            {parseFloat((1 / conversionRates.GHS).toFixed(4))}
          </p>
        )}
